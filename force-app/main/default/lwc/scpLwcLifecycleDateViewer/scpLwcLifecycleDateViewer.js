 ...
 */
export default class ScpLwcLifecycleDateViewer extends LightningElement {
  @api
  showDayOfWeek = false; 
  ...
  constructor() {
    super();
    console.log(` >> c-date-viewer: constructor() [Has No Access to Public Properties]`);
  }

  connectedCallback() {
    console.log(` >> c-date-viewer: connectedCallback() ${this.additionalLogDetails}`);
  }

  renderedCallback() {
    console.log(` >> c-date-viewer: renderedCallback() ${this.additionalLogDetails}`);
  }

  disconnectedCallback() {
    console.log(` >> c-date-viewer: disconnectedCallback() ${this.additionalLogDetails}`);
  }
  ...
  get dateValue() {
    ...
    if (this.showNextDayOfWeek) {
      ...
      dayOfWeek = dateToCalculate.toLocaleString("default", { weekday: "long" });
    }
